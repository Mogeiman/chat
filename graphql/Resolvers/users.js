      ...
      login: async(_, args) =>{
        ...
        try{
            ...
            const token = jwt.sign(
                {username}, process.env.TOKEN_SECRET, {expiresIn: 60*60}
                )
    ...
    Mutation: {
        register: async (_,args)=>{
            ...
            try{
                ...
                // if(userNameExists) errors.userNameExists='username is taken'
                // if(emailExists) errors.userNameExists='email is taken'
                ...
                throw new UserInputError('Terrible input', {errors})
            }
        },
    }
  };